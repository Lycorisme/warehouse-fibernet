...
class MerkController extends Controller
{
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $array = array(
                        ...
                        // REVISI: Menggunakan merk_initial
                        "merk_initial" => $row->merk_initial,
    ...
    public function proses_tambah(Request $request)
    {
        ...
        MerkModel::create([
            ...
            // REVISI: Simpan ke kolom merk_initial
            'merk_initial' => $request->kode,
            'merk_slug' => $slug,
    ...
    public function proses_ubah(Request $request, MerkModel $merk)
    {
        ...
        $merk->update([
            'merk_nama' => $request->merk,
            // REVISI: Update kolom merk_initial
            'merk_initial' => $request->kode,
            'merk_slug' => $slug,
            'merk_keterangan' => $request->ket,
        ]);
