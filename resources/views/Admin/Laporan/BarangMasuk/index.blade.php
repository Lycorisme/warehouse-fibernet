        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header border-bottom-0 pb-0 d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center">
                    <div>
                        <h3 class="card-title fw-bold fs-18">Rekap Laporan Barang Masuk</h3>
                        <p class="text-muted fs-12 mb-0">Analisis dan cetak rekapitulasi data barang masuk berdasarkan periode dan kategori.</p>
                    </div>
                </div>
                    ...
                    <div class="bg-light p-4 rounded-3 mb-4 section-filter">
                        <div class="row g-3">
                            ...
                            <div class="col-12 mt-3 d-flex gap-2">
                                ...
                                <button class="btn btn-outline-danger px-4" onclick="print()"><i class="fe fe-printer me-2"></i>Print PDF</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="table-1" width="100%"
                            ...
                            <thead class="bg-light-50">
                                ...
                                <th class="border-bottom-0 text-muted fw-bold">TANGGAL</th>
                                <th class="border-bottom-0 text-muted fw-bold">KODE MASUK</th>
                                ...
                                <th class="border-bottom-0 text-muted fw-bold text-center">JUMLAH</th>
                                <th class="border-bottom-0 text-muted fw-bold text-center">SN</th>
                            </thead>
                            <tbody></tbody>
                        </table>
                    </div>
