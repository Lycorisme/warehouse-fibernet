        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header border-bottom-0 pb-0 d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center">
                    <div>
                        <h3 class="card-title fw-bold fs-18">Rekap Laporan Barang Keluar</h3>
                        <p class="text-muted fs-12 mb-0">Analisis dan cetak rekapitulasi data barang keluar berdasarkan periode dan kategori.</p>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="table-1" width="100%"
                            ...
                            <thead class="bg-light-50">
                                ...
                                <th class="border-bottom-0 text-muted fw-bold">KODE KELUAR</th>
        ...
        function getData() {
            table = $('#table-1').DataTable({
                ...
                "columns": [{
                    ...
                    {
                        data: 'jenisbarang_nama', // DATA JENIS BARANG
