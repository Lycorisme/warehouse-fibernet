                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <button class="btn btn-primary-light" onclick="print()"><i class="fe fe-printer"></i>
                                Print</button>
                            {{-- <button class="btn btn-danger-light" onclick="pdf()"><i class="fe fe-file-text"></i>
                                PDF</button> --}}
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="table-1"
                            ...
                            <thead>
                                ...
                                <th class="border-bottom-0">Kode Rusak</th>
...
@section('scripts')
    <script>
        ...
        var table; // Definisikan variabel table di luar agar bisa diakses fungsi lain
        ...
        function getData() {
            table = $('#table-1').DataTable({
                ...
                lengthChange: true,
                "ajax": {
                    "url": "{{ route('lap-br.getlap-br') }}", // Route baru untuk Laporan Barang Rusak
                    "data": function(d) {
        ...
        function print() {
            ...
            window.open(
                "{{ route('lap-br.print') }}?tglawal=" + tglawal + "&tglakhir=" + tglakhir +
        ...
        function pdf() {
            ...
            window.open(
                "{{ route('lap-br.pdf') }}?tglawal=" + tglawal + "&tglakhir=" + tglakhir +
                "&search_nama=" + search_nama + "&filter_jenis=" + filter_jenis,
                '_blank'
            );
        }
