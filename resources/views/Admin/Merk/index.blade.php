        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header border-bottom-0 pb-0 d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center">
                    <div>
                        <h3 class="card-title fw-bold fs-18">Daftar Merk Barang</h3>
                        <p class="text-muted fs-12 mb-0">Kelola dan lihat data merk barang yang tersedia.</p>
                    </div>
                    @if ($hakTambah > 0)
                        <div class="mt-3 mt-sm-0">
                            <a class="modal-effect btn btn-primary box-primary-shadow px-4 py-2"
                                ...
                                <i class="fe fe-plus-circle me-2"></i>Tambah Merk</a>
                        </div>
                    @endif
                </div>
